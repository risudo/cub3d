...
void init_texs(t_game *game) {
    init_tex(&game->tex_n, game->mlx, "./textures/wall.xpm");
    init_tex(&game->tex_s, game->mlx, "./textures/collectible.xpm");
    init_tex(&game->tex_w, game->mlx, "./textures/exit.xpm");
    init_tex(&game->tex_e, game->mlx, "./textures/player3.xpm");
}
...
char *map[] = {"111111111111111111111111", "100000000000000000000001",
               ...
               "100000000000000000000001", "100000000000000000000001",
               "100000000000000000000001", "100000000000000000000001",
               "1444444000000000000001", "140400004000000000000001",
...
void calc_wall_height(t_game *game, t_ray *ray) {
    ...
    ray->drawStart =
        -ray->lineHeight / 2 + game->screenHeight / 2 + game->pitch;
    if (ray->drawStart < 0)
        ray->drawStart = 0;
